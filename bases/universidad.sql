...
CREATE DATABASE universidad WITH ENCODING='UTF8';
\c universidad
...
INSERT INTO asignatura VALUES (1, 'Álgebra lineal y matemática discreta', 6, 'básica', 1, 1, 3, 4);
...
INSERT INTO matricula VALUES (1, 2, 1);
INSERT INTO matricula VALUES (1, 3, 1);
INSERT INTO matricula VALUES (2, 1, 1);
INSERT INTO matricula VALUES (2, 2, 1);
INSERT INTO matricula VALUES (2, 3, 1);
INSERT INTO matricula VALUES (4, 1, 1);
INSERT INTO matricula VALUES (4, 2, 1);
INSERT INTO matricula VALUES (4, 3, 1);
INSERT INTO matricula VALUES (24, 1, 5);
INSERT INTO matricula VALUES (24, 2, 5);
INSERT INTO matricula VALUES (24, 3, 5);
INSERT INTO matricula VALUES (24, 4, 5);
INSERT INTO matricula VALUES (24, 5, 5);
INSERT INTO matricula VALUES (24, 6, 5);
INSERT INTO matricula VALUES (24, 7, 5);
INSERT INTO matricula VALUES (24, 8, 5);
INSERT INTO matricula VALUES (24, 9, 5);
INSERT INTO matricula VALUES (24, 10, 5);
INSERT INTO matricula VALUES (23, 1, 5);
INSERT INTO matricula VALUES (23, 2, 5);
INSERT INTO matricula VALUES (23, 3, 5);
INSERT INTO matricula VALUES (23, 4, 5);
INSERT INTO matricula VALUES (23, 5, 5);
INSERT INTO matricula VALUES (23, 6, 5);
INSERT INTO matricula VALUES (23, 7, 5);
INSERT INTO matricula VALUES (23, 8, 5);
INSERT INTO matricula VALUES (23, 9, 5);
INSERT INTO matricula VALUES (23, 10, 5);
INSERT INTO matricula VALUES (19, 1, 5);
INSERT INTO matricula VALUES (19, 2, 5);
INSERT INTO matricula VALUES (19, 3, 5);
INSERT INTO matricula VALUES (19, 4, 5);
INSERT INTO matricula VALUES (19, 5, 5);
INSERT INTO matricula VALUES (19, 6, 5);
INSERT INTO matricula VALUES (19, 7, 5);
INSERT INTO matricula VALUES (19, 8, 5);
INSERT INTO matricula VALUES (19, 9, 5);
INSERT INTO matricula VALUES (19, 10, 5);
...
--forma 1
    ...
    FROM persona
    WHERE telefono = ("alumno") AND 
    fecha_nacimiento >= "1999-1-1" AND <= "1999-12-31";
--forma 2
    SELECT apellido1, apellido2, nombre
    FROM persona
    WHERE telefono = ("alumno") AND 
    fecha_nacimiento BETWEEN "1999-1-1" AND "1999-12-31";
--forma 3
    SELECT apellido1, apellido2, nombre
    FROM persona
    WHERE telefono = ("alumno") AND 
    EXTRACT (YEAR FROM fecha_nacimiento) = "1999";

--Consuta para ver como funciona EXTRACT (sacar las personas que nacieron en enero)
    SELECT apellido1, apellido2, nombre
    FROM persona
    EXTRACT (MONTH FROM fecha_nacimiento) = "1";
...
--Ejercicio Multitabla 1
    SELECT nombre, apellido1, apellido2
    FROM persona 
    INNER JOIN matricula ON persona.id_alumno = matricula.id_alumno
    INNER JOIN asignatura ON asignatura.id_asignatura = asignatura.id
    INNER JOIN grado ON asignatura.id_grado = id_grado
    WHERE sexo ("M") AND grado.nombre = "Grado en Ingeniería Informática(Plan 2015)";

--Ejercicio Multitabla2
SELECT asignatura.nombre
FROM asignatura
INNER JOIN grado ON asignatura.id_grado = grado.id
WHERE grado.nombre LIKE "a"


SELECT apellido1, apellido2, persona.nombre, departamento.nombre
FROM persona
INNER JOIN profesor ON persona.id_profesor
...
FROM persona
INNER JOIN persona ON persona.id = matricula.id_alumno
INNER JOIN asignatura ON asignatura.id = matri.id_asignatura
INNER JOIN curso_escolar ON curso_escolar.id = matricula.id_curso_escolar
WHERE NIF = "26902806M";




SELECT nombre, apellido1, persona.nombre
